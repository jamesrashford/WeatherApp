...
public class WeatherConditions {
    ...
    public static final String WEATHER_CLOUDY_WITH_SLEET = "cloudy with sleet";
    public static final String WEATHER_HAIL_SHOWER_NIGHT = "hail shower (night)";
    public static final String WEATHER_HAIL_SHOWER_DAY = "hail shower (day)";
    public static final String WEATHER_CLOUDY_HAIL = "cloudy with hail";
    public static final String WEATHER_LIGHT_SNOW_SHOWER_NIGHT = "light snow shower (night)";
    public static final String WEATHER_LIGHT_SNOW_SHOWER_DAY = "light snow shower (day)";
    public static final String WEATHER_CLOUDY_LIGHT_SNOW = "cloudy with light snow";
    public static final String WEATHER_HEAVY_SHOW_SHOWER_NIGHT = "heavy snow shower (night)";
    public static final String WEATHER_HEAVY_SHOW_SHOWER_DAY = "heavy snow shower (day)";
    public static final String WEATHER_CLOUDY_WITH_HEAVY_SNOW = "cloudy with heavy snow";
    public static final String WEATHER_THUNDERY_SHOWER_NIGHT = "thundery shower (night)";
    public static final String WEATHER_THUNDERY_SHOWER_DAY = "thundery shower (day)";
    ...
    public static final String WEATHER_TROPICAL_STORM = "tropical storm";
    public static final String WEATHER_HAZY = "hazy";
}
